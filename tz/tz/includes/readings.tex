...
\begin{enumerate}
    ...
    \item coderoad // [Электронный ресурс]. Режим доступа: https://coderoad.ru/, свободный (Дата обращения: 04.21.2020)
    \item developer.mozilla [Электронный ресурс]. Режим доступа: https://developer.mozilla.org, свободный (Дата обращения: 02.23.2020)
    ...
    \item htmlbook // [Электронный ресурс]. Режим доступа: http://htmlbook.ru/, свободный (Дата обращения: 04.09.2020)
    \item htmlweb // [Электронный ресурс]. Режим доступа: https://htmlweb.ru/, свободный (Дата обращения: 04.11.2020)
